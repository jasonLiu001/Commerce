...
namespace DataAccess
{
    public class SqlServerDataService
    {
        public List<Article> GetArticleList(int pageIndex, int pageSize)
        {
            ...
            var list = Utility.GetListFromSqlServer<Article>(new string[] { "title", "site_name", "url", "media_type", "polarity", "publish_date", "same_doc_count", "address", "[content]" }, sql);
            return list;
        }
        ...
        public List<HotWord> GetHotWordsList()
        {
            ...
            var list = Utility.GetListFromSqlServer<HotWord>(new string[] { "id", "hotword" }, sql);
            return list;
        }
        ...
        public List<Company> GetCompanyList()
        {
            ...
            var list = Utility.GetListFromSqlServer<Company>(new string[] { "id", "company_name", "company_name_short", "company_boss" }, sql);
            return list;
        }
        ...
        public List<CategoryPercentage> GetCategoryPercentageList()
        {
            ...
            var list = Utility.GetListFromSqlServer<CategoryPercentage>(new string[] { "id", "news", "blog", "forum", "media", "weibo", "weixin", "total_counts" }, sql);
            return list;
        }
        ...
        public List<EmotionPercentage> GetEmotionPercentageList()
        {
            ...
            var list = Utility.GetListFromSqlServer<EmotionPercentage>(new string[] { "id", "positive", "negative", "total_counts" }, sql);
            return list;
        }
        ...
        public List<HotWordPercentage> GetHotWordPercentageList(string keyWord = "hotword", string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<HotWordPercentage>(new string[] { "hotword", "hotword_counts" }, sql);
            return list;
        }
        ...
        public List<SiteRank> GetSiteRankList(string keyWord = "hotword", string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<SiteRank>(new string[] { "site_name", "news_counts" }, sql);
            return list;
        }
        ...
        public List<RegionDetail> GetAreasList()
        {
            ...
            var list = Utility.GetListFromSqlServer<RegionDetail>(new string[] { "area" }, sql);
            return list;
        }
        ...
        public List<AreaRank> GetAreaRankList(string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<AreaRank>(new string[] { "city", "frequency" }, sql);
            return list;
        }
        ...
        public List<PeopleRank> GetPeopleRankList(string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<PeopleRank>(new string[] { "people", "frequency" }, sql);
            return list;
        }
        ...
        public List<CompanyRank> GetCompanyRankList(string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<CompanyRank>(new string[] { "company_name", "frequency" }, sql);
            return list;
        }
        ...
        public List<HotwordRank> GetHotwordRankList(string topCount = "5", string publishDate = "2015-05-27")
        {
            ...
            var list = Utility.GetListFromSqlServer<HotwordRank>(new string[] { "hotword", "frequency" }, sql);
            return list;
        }
        #endregion
    }
